...
public class CandleStickIndicatorsGlobal {
	...
	private ObjectPool initMySqlConnectionPool() {
		...
		String port = "3306";
		String schema = "engine_candlestick";
		String user = "root";
	...
	private static final CandleStickIndicatorsGlobal instance = new CandleStickIndicatorsGlobal();
    
    //private constructor to avoid client applications to use constructor
    private CandleStickIndicatorsGlobal(){
    	this.setPool(initMySqlConnectionPool());
    	
    }

    public static CandleStickIndicatorsGlobal getInstance(){
        return instance;
    }
